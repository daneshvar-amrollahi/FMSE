...
short src_ln4 [] = {
	  0,  44,  45,  46,  47,  43,  50,   0, };
S_F_MAP src_file4 [] = {
	{ "-", 0, 0 },
	{ "../Examples/P1-1.pml", 1, 6 },
	{ "-", 7, 8 }
};
uchar reached4 [] = {
	  0,   1,   0,   0,   0,   0,   0,   0, };
...
short src_ln3 [] = {
	  0,  37,  37,  37,  37,  37,  37,  38, 
	 38,  38,  38,  38,  38,  36,  40,  36, 
	 40,   0, };
S_F_MAP src_file3 [] = {
	{ "-", 0, 0 },
	{ "../Examples/P1-1.pml", 1, 16 },
	{ "-", 17, 18 }
};
uchar reached3 [] = {
	  0,   1,   0,   0,   0,   0,   1,   1, 
...
short src_ln2 [] = {
	  0,  29,  29,  29,  29,  29,  29,  30, 
	 30,  30,  30,  30,  30,  28,  32,  28, 
	 32,   0, };
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "../Examples/P1-1.pml", 1, 16 },
...
short src_ln1 [] = {
	  0,  21,  21,  21,  21,  21,  21,  22, 
	 22,  22,  22,  22,  22,  20,  24,  20, 
	 24,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "../Examples/P1-1.pml", 1, 16 },
...
short src_ln0 [] = {
	  0,  13,  13,  13,  13,  13,  13,  14, 
	 14,  14,  14,  14,  14,  12,  16,  12, 
	 16,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "../Examples/P1-1.pml", 1, 16 },
...
iniglobals(int calling_pid)
{
		...
		now.pos = 0;
#ifdef VAR_RANGES
		logval("tokenA", now.tokenA);
		logval("tokenB", now.tokenB);
		logval("tokenC", now.tokenC);
		logval("tokenD", now.tokenD);
		logval("pos", now.pos);
#endif
}
